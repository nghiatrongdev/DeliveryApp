...
internal enum FontFamily {
  ...
  internal enum RobotoMono {
    internal static let regular = FontConvertible(name: "RobotoMono-Regular", family: "Roboto Mono", path: "RobotoMono-Regular.ttf")
    internal static let all: [FontConvertible] = [regular]
  }
  internal static let allCustomFonts: [FontConvertible] = [Poppins.all, Roboto.all, RobotoMono.all].flatMap { $0 }
