...
internal enum Asset {
  internal enum Assets {
    ...
    internal static let checkboxdefaultfalse = ImageAsset(name: "checkboxdefaultfalse")
    internal static let checkboxdefaulttrue = ImageAsset(name: "checkboxdefaulttrue")
    internal static let checkboxdisablefalse = ImageAsset(name: "checkboxdisablefalse")
    internal static let checkboxdisabletrue = ImageAsset(name: "checkboxdisabletrue")
    internal static let activeFalse = ImageAsset(name: "Active=False")
    internal static let activeTrue = ImageAsset(name: "Active=True")
    ...
    internal static let notificationTilted = ImageAsset(name: "Notification tilted")
    ...
    internal static let icTriangle = ImageAsset(name: "ic_triangle")
    internal static let birthdayGirl = ImageAsset(name: "Birthday girl")
    internal static let burger = ImageAsset(name: "Burger")
    internal static let chefCooking = ImageAsset(name: "Chef cooking")
    internal static let deliveryGuy = ImageAsset(name: "Delivery guy")
    internal static let emptyState = ImageAsset(name: "Empty state")
    internal static let splash = ImageAsset(name: "Splash")
    internal static let typeSizeBobaFood = ImageAsset(name: "Type & size=Boba Food +")
    internal static let typeSizeDefault = ImageAsset(name: "Type & size=Default")
    internal static let typeSizeLogoIcon = ImageAsset(name: "Type & size=Logo icon")
    internal static let typeSizeSmall = ImageAsset(name: "Type & size=Small")
    internal static let radiodefaultfalse = ImageAsset(name: "radiodefaultfalse")
    internal static let radiodefaulttrue = ImageAsset(name: "radiodefaulttrue")
    internal static let radiodisablefalse = ImageAsset(name: "radiodisablefalse")
    internal static let radiodisabletrue = ImageAsset(name: "radiodisabletrue")
  }
